package fontys.s3.MonsterEnergyCollection.Security.IsAuthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fontys.s3.MonsterEnergyCollection.Security.IsAuthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fontys.s3.MonsterEnergyCollection.Security.IsAuthenticated.IsAuthenticated)")
