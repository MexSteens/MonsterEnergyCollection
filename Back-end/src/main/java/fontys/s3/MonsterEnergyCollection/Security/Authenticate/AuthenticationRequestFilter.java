package fontys.s3.MonsterEnergyCollection.Security.Authenticate;
...
public class AuthenticationRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private AccessToken accessTokenDecoder;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            fontys.s3.MonsterEnergyCollection.Domain.AccessToken accessTokenDTO = accessTokenDecoder.Decode(accessToken);
    ...
    private void setupSpringSecurityContext(fontys.s3.MonsterEnergyCollection.Domain.AccessToken accessToken) {
