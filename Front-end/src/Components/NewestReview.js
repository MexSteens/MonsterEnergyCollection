...
const NewestReview = (comment) => {
    ...
    return <div className="container-comment p-2 rounded-lg shadow border border-register-login bg-black" name={comment.comment.userEntity.username}>
        ...
        <div className="flex items-center justify-center py-2 rounded-b">
            ...
            <button onClick={removeComment} type="button" name="delete-comment" className="w-full text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-lg px-4 py-2 text-center focus:ring-primary-800 bg-purple-600 ml-2">
                Go to can
            </button> */}
        </div>
    </div>
